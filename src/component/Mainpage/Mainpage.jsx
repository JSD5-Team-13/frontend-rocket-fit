...
const Mainpage = () => {
  ...
  return (
    <>
      <NavbarLoggedIn />
      <div className="flex flex-row max-w-screen-2xl my-0 mx-auto md:m-auto relative">
        <aside className="lg:w-1/4 max-w-[385px] hidden lg:block shadow-lg fixed mt-[79px]">
          <SideInformation />
        </aside>

        <div className="lg:w-2/4 flex flex-col bg-gray-100 items-center lg:ml-[385px] mt-[79px]">
          ...
          <img
            ...
            alt="banner"
            className="w-[80%] h-[20%] object-cover rounded-lg"
          />
          {/* Form Area */}
          {/* Crete Activity Area */}
          <div className="card card-side card-compact bg-base-300 shadow-xl w-[80%] my-4">
            ...
            <div className="card-body">
              ...
              <a href="/create_activity">
                <button className="btn btn-sm btn-accent rounded-full w-[50%] lg:w-[40%]">
                  Create Activity
                </button>
              </a>
            </div>
          ...
          <div className="card card-side card-compact bg-base-300 shadow-xl w-[80%] my-4">
            ...
            <div className="card-body w-[80%]">
              ...
              <p>
                How was your night ? Enter your sleep and wake up time to track
                your sleeping
              </p>
        ...
        <div className="hidden lg:flex flex-col lg:w-1/4 shadow-md mt-[79px] h-[100vh]">
          <div className="m-6 self-start">
