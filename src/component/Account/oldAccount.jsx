...
const AccountSetting = () => {
  ...
  return (
    <Layout className="max-w-[1440px] flex items-center">
      <div className="flex flex-col justify-between flex-grow w-full h-[95vh]  lg:hidden">
        <div>
          ...
          <div>
            ...
            <div
              id="accountMobile"
              className="flex flex-col justify-center gap-0 mx-2 my-4 md:mx-auto items:center md:min-w-[640px] tablet:w-4/6 lg:hidden md:border lg:rounded-lg"
            >
              <div className="">
                <Account />
              </div>
      ...
      <div className="flex-col p-[2rem] hidden lg:block justify-center mx-auto items-center w-full max-w-[1440px]">
