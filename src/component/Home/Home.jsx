...
const Home = () => {
  return (
      <section className="max-w-screen-2xl my-0 mx-auto">
        <Navbar />
          ...
          <div className="flex flex-col-reverse lg:flex lg:flex-row lg:justify-center lg:my-[5rem]">
            ...
            <div className="">
              <div className="p-[2rem] lg:flex lg:flex-col lg:items-center">
                <span className="font-bold text-[2.5rem] xl:text-[3.5rem]">Welcome to</span>
              ...
              <div className="px-[2rem] flex flex-col gap-y-2">
                <p className="font-bold lg:text-[1.2rem] xl:text-[1.5rem]">Stronger Every Move Fitter Every Day</p>
                <p className="lg:text-[1rem] xl:text-[1.3rem]">with our tracker site to manage your time.</p>
              </div>

              <div className="mt-[1.5rem] flex items-center justify-center">
                <button className="btn btn-accent text-white w-[70%] rounded-[2rem]">Sign in</button>
              </div>
              
              <div>
                <p className="text-[13px] text-center mt-1 font-bold lg:m-[1rem] xl:text-[1.1rem]">
                  Doesn have an account ?<span className="hover:cursor-pointer ml-3">Register here</span>
                </p>
              </div>
            </div>
        ...
        {/* ส่วนของ Contact Us */}
        <article className="lg:flex lg:items-center lg:justify-center lg:relative">
          ...
          {/* รูปที่จะใช้เป็น Bg */}
          <img className="w-full object-cover hidden lg:flex" src={Bgcontactus} alt="" />
        </article>
        <FooterHome />
      </section>
  );
